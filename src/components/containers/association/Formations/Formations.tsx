...
//import styles from '../../../../../styles/RescoeAsso.module.css'; // Chemin correct
...
const Formations = () => {
  ...
  return (
    <Box p={5} className={styles['app-container']}>

      {/* Titre principal */}
      <Heading as="h1" size="xl" textAlign="center" mb={10} className={styles['neon-heading']}>
