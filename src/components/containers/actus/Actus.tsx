...
useEffect(() => {
  if (collections.length > 0) {
    ...
    if (artCollections.length > 0) {
      ...
      fetchNFTs(randomArtCollection.id[0], randomArtCollection.mintContractAddress[0]);
    }
    ...
    if (poetryCollections.length > 0) {
      ...
      fetchPoems(randomPoetryCollection.id[0], randomPoetryCollection.mintContractAddress[0]);
    }
  }
}, [collections]);
